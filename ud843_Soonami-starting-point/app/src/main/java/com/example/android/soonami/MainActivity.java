...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2018-01-01&endtime=2018-04-01&minmagnitude=7";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                int ans = urlConnection.getResponseCode();
                if(ans != 200){
                    Log.e(LOG_TAG, "Error with creating URLConnection. Error type : " + ans);
                    return "";
                }
            } finally {
         ...
         * ab   out the first earthquake from the input earthquakeJSON string.
         */
